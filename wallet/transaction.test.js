...
describe('Transaction', () => {
    ...
    describe('update()', () => {
        ...
        describe('and the amount is valid', () => {
            ...
            it('outputs the mount to the next recipient', () => {
                expect(transaction.outputMap[nextRecipient]).toEqual(nextAmount);
            });
    
            it('substracts from the original sender output amount', () => {
    ...
    describe('rewardTransaction()', () => {
        ...
        it('create one transaction for the miner with `MINING_REWARD`', () => {
